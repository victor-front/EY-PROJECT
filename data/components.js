...
<div style="display: flex; margin-top: 20px;">
	<p style="font-size: 1.8em; color: #ddd; margin-left: 1em;">${msg}</p>
...
const criarConta = () => `
	<section id="criarConta">
		...
		<div id="form">
			...
			<input id="dark" type="radio" name="radtem" checked><label for="dark">Dark</label>
			<input id="light" type="radio" name="radtem"><label for="light">Light</label><br>
